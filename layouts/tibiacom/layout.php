...
<?php
  $bg = array('01.jpg', '02.jpg', '03.jpg', '04.jpg', '05.jpg', '06.jpg', '07.jpg', '08.jpg', '09.jpg', '10.jpg', '11.jpg', '12.jpg'); // array of filenames
...
<a href="?subtopic=changelog">
  	<div id="submenu_changelog" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
	    ...
	    <div id="ActiveSubmenuItemLabel_changelog" class="SubmenuitemLabel">Changelog</div>
...
<?php echo $cast1; ?>
                                ...
                                ?>
                                    ...
                                    <div id="RightArtwork">
                                    <img id="Creature" src="<?php echo $config['site']['animatedOutfits_url'] ?>?id=<?php echo $creaturetype; ?>&addons=<?php echo $creatureaddons; ?>&head=<?php echo $creaturehead; ?>&body=<?php echo $creaturebody; ?>&legs=<?php echo $creaturelegs; ?>&feet=<?php echo $creaturefeet; ?>&mount=<?php echo $creaturemount; ?>" alt="Creature of the Day" title="Today's boosted creature: <?PHP echo ucwords(strtolower(trim($creaturename))); ?>">
                                    <img id="Boss" src="<?php echo $config['site']['animatedOutfits_url'] ?>?id=<?php echo $bosstype; ?>&addons=<?php echo $bossaddons; ?>&head=<?php echo $bosshead; ?>&body=<?php echo $bossbody; ?>&legs=<?php echo $bosslegs; ?>&feet=<?php echo $bossfeet; ?>&mount=<?php echo $bossmount; ?>" alt="Boss of the Day" title="Today's boosted boss: <?PHP echo ucwords(strtolower(trim($bossname))); ?>">
                                    <img id="PedestalAndOnline" src="<?PHP echo $layout_name; ?>/images/global/header/pedestal.gif" alt="Monster Pedestal and Players Online Box">
                                </div>
                                        <div id="Themeboxes">
...
<?php if (Website::getWebsiteConfig()->getValue('widget_Serverinfoboxfloat')) { ?>
    ...
    <!-- float discord start -->
    <script id="float_dc" src="<?= $layout_name ?>/js/dc_float_plugin.js<?php echo $css_version; ?>"
