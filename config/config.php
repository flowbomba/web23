...
if ($config['base_url'] == $config['site']['realurl'] || $config['base_url'] == $config['site']['realurlwww']) {
    $config['site']['serverPath'] = "C:\_OT FURERA 12.86\SERVER DATA/"; //SERVER PATH EM PRODUÇÃO
} else {
    $config['site']['serverPath'] = "C:\_OT FURERA 12.86\SERVER DATA/"; //SERVERPATH LOCALHOST
}
/** END SERVER PATHS */
...
$config['site']['start'] = 'Dec 01, 2022 22:00:00';


/** GOOGLE RECAPTCHA VALUES */
$config['site']['gRecaptchaSecret'] = "6LeNzrgZAAAAACmWCEFW5M-MAqh3kAzH74S7062H";
$config['site']['gRecaptchaSiteKey'] = "6LeNzrgZAAAAAGp4wtcYALeB3_0CYXfazuSpwMny";
...
$config['social']['facebook'] = "https://www.facebook.com/facebook"; // Link to your facebook page
...
$config['site']['sqlPass'] = "crissin65";
$config['site']['sqlBD'] = "furera2023";
